...
export default class InfiniteLogoCarousel extends Component {
  render() {
    ...
    return (
      <div className="my-20">
        <div className="relative text-3xl font-medium py-10 text-center mb-12 border-b-2 border-gray-300">
          <span className="font-bold">10,00,000+ </span>professionals from over{" "}
          <span className="font-bold">12,000</span> companies are using{" "}
          <span className="font-bold">Recruitify.</span>
          <img
            src={scrollBackground}
            alt=""
            className="absolute top-0 z-[-1] h-full w-full opacity-70"
          />
        </div>
        ...
        <div className="mainContainer border-b-2 border-gray-300 pb-8 mb-12">
          <Slider {...settings}>
            <div className="md:p-10">
              <img
                className="h-24 flex items-center justify-center mx-auto text-center"
            ...
            <div className="md:p-10">
              <img
                className="h-24 flex items-center justify-center mx-auto text-center"
                src="https://logos-world.net/wp-content/uploads/2022/05/Berkshire-Hathaway-Symbol.png"
                alt=""
              />
            </div>
            <div className="md:p-10">
            ...
            <div className="md:p-10">
              <img
                className="h-24 flex items-center justify-center mx-auto text-center"
                src="https://mma.prnewswire.com/media/467598/Oracle_Logo.jpg?p=facebook"
                alt=""
              />
            </div>
            <div className="md:p-10">
              <img
                className="h-24 flex items-center justify-center mx-auto text-center"
                src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/55/Walt_Disney_wordmark.svg/2560px-Walt_Disney_wordmark.svg.png"
                alt=""
              />
            </div>
            <div className="md:p-10">
              <img
                className="h-24 flex items-center justify-center mx-auto text-center"
                src="https://cdn.pixabay.com/photo/2016/08/15/18/19/toyota-1596082_1280.png"
                alt=""
              />
            </div>
            <div className="md:p-10">
            ...
            <div className="md:p-10">
              <img
                className="h-24 flex items-center justify-center mx-auto text-center"
                src="https://cdni.autocarindia.com/Utils/ImageResizer.ashx?n=https://cdni.autocarindia.com/ExtraImages/20200716011427_2020-nissan-brand-logo.jpg&w=700&q=90&c=1"
                alt=""
              />
            </div>
            <div className="md:p-10">
